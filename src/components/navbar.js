      ...
      <nav class="bg-yellow-300">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button
              type="button"
              class="text-white bg-green-700 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-green-200 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-green-700 dark:hover:bg-green-500 dark:focus:ring-green-200"
            >
              Order Now
            </button>
            <button
          ...
          <div
            ...
            id="navbar-cta"
          >
            <ul class="flex flex-col font-medium p-4 gap-8 md:p-0 mt-4 border rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
              <li>
                <a
                  href="#"
